    ...
    <>
      ...
      >
        <div className="find-us-grid">
          <a className="find-us-card social-link" href={clubInstagramUrl} rel="noreferrer" target="_blank" aria-label="Open Purdue Art Community Instagram">
            <div className="social-card-header">
              <span className="social-icon instagram" aria-hidden="true"><InstagramIcon /></span>
              <div>
          ...
          <a className="find-us-card social-link" href={clubGroupMeUrl} rel="noreferrer" target="_blank" aria-label="Join the Purdue Art Community GroupMe">
            <div className="social-card-header">
              <span className="social-icon groupme" aria-hidden="true"><GroupMeIcon /></span>
              <div>
